...
import { selectCellSelection, selectDiceNo, selectPocketPilesSelection } from '../redux/reducers/gameSelectors';
...
const Pile = ({cell, pieceid, color, player, onPress}) => {
  ...
  const currentPlayerPileSelection= useSelector(selectPocketPilesSelection);
